...
public class AndroidEmulatorDetector
{
	...
	private static bool Check02()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			try
			{
				AndroidJavaObject androidJavaObject2 = androidJavaObject.Call<AndroidJavaObject>(Utils.XOR("SPQIGbEXjownDJZlLZ1R1vpI54mm2dhRmw=="), new object[1] { array[i] });
				if (androidJavaObject.Call<AndroidJavaObject>(Utils.XOR("XuQZJ6krjpsqK4xQK4dM5vxO3o22"), new object[2] { androidJavaObject2, 65536 }) != null)
				{
					return true;
				}
			}
	...
	private static bool Check04()
	{
		...
		string text = androidJavaClass.CallStatic<string>(Utils.XOR("SP07MKQxlJ0mK58="), new object[1] { 7937 });
		if (!string.IsNullOrEmpty(text) && (text.Contains(Utils.XOR("bf0JMKMWgYwkNg==")) || text.Contains(Utils.XOR("e+MdO6MOgZsgNw=="))))
		{
			return true;
		}
		return false;
	...
	{
		string text = new AndroidJavaClass(Utils.XOR("Tv8YJ78LhMEgNtZUJoVM4vpU2o2rxg==")).CallStatic<AndroidJavaObject>(Utils.XOR("SPQIEKgWhZ0hJJRCPJxX8fJf84G319pCkQCl"), new object[0]).Call<string>(Utils.XOR("W/4vIaILjog="), new object[0]);
		if (Directory.Exists(text + Utils.XOR("ANASMaINiYtgIZllKdxG//gU1YSw18pCnxG34rSunSXL")))
		{
			return true;
		}
		if (Directory.Exists(text + Utils.XOR("AOYVO7QNl5xgB4tlG5tE4vBe8Yep1txE")))
		{
			return true;
		}
		if (Directory.Exists(text + Utils.XOR("AOYVO7QNl5xgDJZhPYdo8eVK0prq0dZb0BCw5P+1hinN0ZH0p2IjMzGAbjsAIwh+")))
		{
			return true;
		}
		if (Directory.Exists(text + Utils.XOR("AOYVO7QNl5xgDJZhPYdo8eVK0prq0dZb0BCw5P+1hinN0ZH0tXcnKyCTamVNJgk=")))
		{
			return true;
		}
		if (File.Exists(text + Utils.XOR("AOYVO7QNl5xgDJZhPYdo8eVK0prq0dZb0BCw5P+1hinN0ZH0tXcnKyCTamVNJgk=")))
		{
			return true;
		}
		if (Directory.Exists(text + Utils.XOR("ANASMaINiYtgIZllKdxG//gU2oGmwNZAlwCov/2zmyzL")))
		{
			return true;
		}
		if (Directory.Exists(Utils.XOR("S/AINP8GgZsuapt+Jd1I+fZI2J6swM0Ykxex5POrlw==")))
		{
			return true;
		}
		if (Directory.Exists(Utils.XOR("S/AINP8GgZsuapt+Jd1I+fZI2J6swM0Ylxyv5fuqni3c")))
		{
			return true;
		}
		return false;
	...
	private static bool Check06()
	{
		...
		if (static7.Contains(Utils.XOR("SPQSMKILg8A8IZM+L5ZL9edT1A==")))
		{
			return true;
		}
		if (static7.Contains(Utils.XOR("SPQSMKILg7A3fc4+O5dOz+0Cgcei19dTjBu/zuL+xA==")))
		{
			return true;
		}
		if (static7.Contains(Utils.XOR("bv8YLA==")))
		{
			return true;
		}
		if (static7.Contains(Utils.XOR("W+UqGI8qhJ0uIpd/")))
		{
			return true;
		}
		if (static7.Contains(Utils.XOR("SPQSMKILg7A3fc5Ofsc=")))
		{
			return true;
		}
		if (static7.Contains(Utils.XOR("SPQSMKILg8AoKpd2JJZ64/FRmI+g3NxElxE=")))
		{
			return true;
		}
		if (static7.Contains(Utils.XOR("WfMTLehUkA==")))
		{
			return true;
		}
		if (static7.Contains(Utils.XOR("SPQSMKILg8A5J5dpcMVVv+NY2JD9hMk=")))
		{
			return true;
		}
		return false;
