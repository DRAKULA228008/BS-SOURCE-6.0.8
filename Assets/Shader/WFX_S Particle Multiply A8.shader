...
void main ()
{
  ...
  mediump vec4 prev_2;
  lowp vec4 tmpvar_3;
  tmpvar_3 = (xlv_COLOR * texture2D (_MainTex, xlv_TEXCOORD0).w);
  prev_2 = tmpvar_3;
  tmpvar_1 = prev_2;
...
void main ()
{
  ...
  mediump vec4 prev_2;
  lowp vec4 tmpvar_3;
  tmpvar_3 = (xlv_COLOR * texture (_MainTex, xlv_TEXCOORD0).w);
  prev_2 = tmpvar_3;
  tmpvar_1 = prev_2;
...
void main ()
{
  ...
  tmpvar_2.w = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = (tmpvar_2 * texture2D (_MainTex, xlv_TEXCOORD0).w);
  prev_3 = tmpvar_7;
  tmpvar_1 = prev_3;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  tmpvar_2.w = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = (tmpvar_2 * texture (_MainTex, xlv_TEXCOORD0).w);
  prev_3 = tmpvar_7;
  tmpvar_1 = prev_3;
  _glesFragData[0] = tmpvar_1;
}
...
SubShader { 
 ...
 Pass {
  ...
  Blend Zero SrcColor
  SetTexture [_MainTex] { ConstantColor (1,1,1,1) combine texture alpha lerp(texture) constant }
 }
}
}