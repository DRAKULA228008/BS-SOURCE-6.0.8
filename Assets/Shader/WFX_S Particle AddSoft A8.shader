...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = (((2.0 * xlv_COLOR) * _TintColor) * texture2D (_MainTex, xlv_TEXCOORD0).w);
...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = (((2.0 * xlv_COLOR) * _TintColor) * texture (_MainTex, xlv_TEXCOORD0).w);
...
void main ()
{
  ...
  tmpvar_1.w = tmpvar_4;
  lowp vec4 tmpvar_5;
  tmpvar_5 = (((2.0 * tmpvar_1) * _TintColor) * texture2D (_MainTex, xlv_TEXCOORD0).w);
...
void main ()
{
  ...
  tmpvar_1.w = tmpvar_4;
  lowp vec4 tmpvar_5;
  tmpvar_5 = (((2.0 * tmpvar_1) * _TintColor) * texture (_MainTex, xlv_TEXCOORD0).w);
