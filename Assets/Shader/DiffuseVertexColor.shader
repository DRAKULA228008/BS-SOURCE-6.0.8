...
void main ()
{
  ...
  c_6.w = 0.0;
  c_1.w = c_6.w;
  c_1.xyz = (c_6.xyz + (c_3.xyz * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_6 = tmpvar_11;
  lowp vec4 c_12;
  c_12.xyz = ((c_3.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz))
   * tmpvar_6) * 2.0));
  c_12.w = 0.0;
  c_1.w = c_12.w;
  c_1.xyz = (c_12.xyz + (c_3.xyz * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_6 = tmpvar_11;
  c_1.xyz = (c_3.xyz * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_6 * 2.0))));
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_15 = (c_3.xyz * min (lm_12, tmpvar_14));
  c_1.xyz = tmpvar_15;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_6 = tmpvar_8;
  lowp vec4 c_9;
  c_9.xyz = ((c_3.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz))
   * shadow_6) * 2.0));
  c_9.w = 0.0;
  c_1.w = c_9.w;
  c_1.xyz = (c_9.xyz + (c_3.xyz * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_6 = tmpvar_9;
  lowp vec4 c_10;
  c_10.xyz = ((c_3.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz))
   * shadow_6) * 2.0));
  c_10.w = 0.0;
  c_1.w = c_10.w;
  c_1.xyz = (c_10.xyz + (c_3.xyz * xlv_TEXCOORD2));
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_8 = (_LightShadowData.x + (tmpvar_7 * (1.0 - _LightShadowData.x)));
  shadow_6 = tmpvar_8;
  c_1.xyz = (c_3.xyz * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_6 * 2.0))));
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_9 = (_LightShadowData.x + (tmpvar_8 * (1.0 - _LightShadowData.x)));
  shadow_6 = tmpvar_9;
  c_1.xyz = (c_3.xyz * min ((2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_6 * 2.0))));
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_12 = (c_3.xyz * min (lm_9, tmpvar_11));
  c_1.xyz = tmpvar_12;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_13 = (c_3.xyz * min (lm_10, tmpvar_12));
  c_1.xyz = tmpvar_13;
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_11;
  c_11.xyz = ((c_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * atten_10) * 2.0));
  c_11.w = 0.0;
  c_1.xyz = c_11.xyz;
...
void main ()
{
  ...
  c_9.xyz = ((c_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * 
    (texture2D (_LightTextureB0, vec2(tmpvar_8)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)
  ) * 2.0));
  c_9.w = 0.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
...
void main ()
{
  ...
  c_9.xyz = ((c_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * 
    (texture (_LightTextureB0, vec2(tmpvar_8)).w * texture (_LightTexture0, xlv_TEXCOORD3).w)
  ) * 2.0));
  c_9.w = 0.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_7;
  c_7.xyz = ((c_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
...
void main ()
{
  ...
  tmpvar_14 = (c_5.xyz * tmpvar_12.xyz);
  c_13.xyz = tmpvar_14;
  c_13.w = 0.0;
  c_2 = c_13;
  tmpvar_1 = c_2;
